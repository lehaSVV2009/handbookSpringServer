...
public abstract class BaseWebApplicationContextTests {
    ...
    protected ChapterController controller;
    ...
    public void initDispatcherServlet() throws Exception{
        ...
        controller = (ChapterController) applicationContext.getBean("chapterController");
        chapterService = (ChapterService)applicationContext.getBean("chapterService");
